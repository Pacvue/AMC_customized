...
docker tag acm_repeat_purchaser_infer:latest 405907896252.dkr.ecr.us-east-1.amazonaws.com/acm_repeat_purchaser_infer:latest

# docker push <AWS Account ID>.dkr.ecr.us-east-1.amazonaws.com/acm_repeat_purchaser_infer:latest
docker push 405907896252.dkr.ecr.us-east-1.amazonaws.com/acm_repeat_purchaser_infer:latest
